...
impl Neuron {
    ...
    fn activate(&self, inputs: &[f64]) -> f64 {
        ...
        // Usando sigmoide como função de ativação para melhor aprendizado no exemplo do OR
...
impl MLP {
    ...
    fn train(&mut self, training_data: &Vec<(Vec<f64>, Vec<f64>)>, learning_rate: f64, epochs: usize) {
        let mut rng = rand::thread_rng();
...
fn main() {
    ...
    // Treinamento
    mlp.train(&training_data, 0.3, 5000); // Aumentei o learning rate e as épocas
